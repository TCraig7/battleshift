...
describe "users api endpoints" do
  ...
  context "GET /api/v1/users/:id" do
    it "returns a specific user" do
      cj   = User.create!(name: "C.J. Cregg", id: 111, email: "cj@ww.gov", password: "westwingforever")
      toby = User.create!(name: "Toby Ziegler", id: 222, email: "tz@ww.gov", password: "pennsylvania1600")
